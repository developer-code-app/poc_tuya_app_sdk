...
class DeviceAddingAPMode extends StatefulWidget {
  const DeviceAddingAPMode({
  ...
  @override
  State<DeviceAddingAPMode> createState() => _DeviceAddingAPModeState();
}

class _DeviceAddingAPModeState extends State<DeviceAddingAPMode> {
  String token = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Device Adding AP Mode'),
      ),
  ...
  Future<void> startPairingDeviceWithAPMode({
    ...
    try {
      await repository.startPairingDeviceWithAPMode(
        ssid: ssid,
        password: password,
        token: token,
      );
